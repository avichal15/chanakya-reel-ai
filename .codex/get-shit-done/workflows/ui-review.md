...
```bash
UI_AUDITOR_MODEL=$(node "C:/Users/avich/Downloads/chanakya-reel-ai/.codex/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-ui-auditor --raw)
```
...
```markdown
Read C:/Users/avich/Downloads/chanakya-reel-ai/.codex/agents/gsd-ui-auditor.md for instructions.
...
```bash
node "C:/Users/avich/Downloads/chanakya-reel-ai/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs(${padded_phase}): UI audit review" --files "${PHASE_DIR}/${PADDED_PHASE}-UI-REVIEW.md"
```
