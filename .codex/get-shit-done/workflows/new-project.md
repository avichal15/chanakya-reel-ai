...
```bash
INIT=$(node "C:/Users/avich/Downloads/chanakya-reel-ai/.codex/get-shit-done/bin/gsd-tools.cjs" init new-project)
...
```bash
mkdir -p .planning
node "C:/Users/avich/Downloads/chanakya-reel-ai/.codex/get-shit-done/bin/gsd-tools.cjs" commit "chore: add project config" --files .planning/config.json
```

**Persist auto-advance chain flag to config (survives context compaction):**

```bash
node "C:/Users/avich/Downloads/chanakya-reel-ai/.codex/get-shit-done/bin/gsd-tools.cjs" config-set workflow._auto_chain_active true
```
...
```bash
mkdir -p .planning
node "C:/Users/avich/Downloads/chanakya-reel-ai/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: initialize project" --files .planning/PROJECT.md
```
...
Use template: C:/Users/avich/Downloads/chanakya-reel-ai/.codex/get-shit-done/templates/research-project/STACK.md
</output>
...
Use template: C:/Users/avich/Downloads/chanakya-reel-ai/.codex/get-shit-done/templates/research-project/FEATURES.md
</output>
...
Use template: C:/Users/avich/Downloads/chanakya-reel-ai/.codex/get-shit-done/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: C:/Users/avich/Downloads/chanakya-reel-ai/.codex/get-shit-done/templates/research-project/PITFALLS.md
</output>
...
Use template: C:/Users/avich/Downloads/chanakya-reel-ai/.codex/get-shit-done/templates/research-project/SUMMARY.md
...
```bash
node "C:/Users/avich/Downloads/chanakya-reel-ai/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: define v1 requirements" --files .planning/REQUIREMENTS.md
```
...
```bash
node "C:/Users/avich/Downloads/chanakya-reel-ai/.codex/get-shit-done/bin/gsd-tools.cjs" generate-claude-md
```
...
```bash
node "C:/Users/avich/Downloads/chanakya-reel-ai/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: create roadmap ([N] phases)" --files .planning/ROADMAP.md .planning/STATE.md .planning/REQUIREMENTS.md AGENTS.md
```
...
```bash
PHASE1_SECTION=$(node "C:/Users/avich/Downloads/chanakya-reel-ai/.codex/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase 1 2>/dev/null)
