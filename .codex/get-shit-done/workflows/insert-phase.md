...
```bash
INIT=$(node "C:/Users/avich/Downloads/chanakya-reel-ai/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${after_phase}")
...
```bash
RESULT=$(node "C:/Users/avich/Downloads/chanakya-reel-ai/.codex/get-shit-done/bin/gsd-tools.cjs" phase insert "${after_phase}" "${description}")
```
