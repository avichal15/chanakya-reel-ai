...
```bash
INIT=$(node "C:/Users/avich/Downloads/chanakya-reel-ai/.codex/get-shit-done/bin/gsd-tools.cjs" init map-codebase)
...
```bash
node "C:/Users/avich/Downloads/chanakya-reel-ai/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: map existing codebase" --files .planning/codebase/*.md
```
